...
/**
 * Taken and modified from http://devmag.org.za/2009/04/25/perlin-noise/
 */
class NoiseUtils
{
	...
	public static float[][] GeneratePerlinNoise(int width, int height, int octaveCount, int seed = 0)
	{
